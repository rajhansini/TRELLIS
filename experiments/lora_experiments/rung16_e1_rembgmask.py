...
_CFG = dict(
    variant='v1_crossattn_lora_randt_rembgmask',
...
_LABEL = (f'rung16e1_{args.train_mask}_{args.tsample}_{args.blocks}'
...
def main():
    ...
    print('=' * 72)
    print('rung16-E1 — rung15 + the TRAINING loss mask fixed (rembg u2net)')
