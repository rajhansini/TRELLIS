...
_CFG = dict(
    variant='v1_crossattn_lora_randt',
...
_LABEL = (f'rung15v1_{args.tsample}_{args.blocks}_{args.targets}'
          f'_r{args.rank}_s{args.seed}_{RUN_ID}')
_OUT   = _RUNS / _LABEL
...
def main():
    ...
    print('=' * 72)
    print('rung15-v1 — cross-attention LoRA, gradient at a RANDOM schedule knot')
