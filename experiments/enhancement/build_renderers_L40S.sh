#!/bin/bash
# Rebuild nvdiffrast + diff-gaussian-rasterization for L40S nodes (sm_89)
set -e
...
BUILD_DIR=/tmp/renderer_build_L40S_$$
mkdir -p "$BUILD_DIR"
echo "Build dir: $BUILD_DIR"

# ── 1. nvdiffrast ─────────────────────────────────────────────────────────────
echo ""
echo "=== Rebuilding nvdiffrast for sm_89 ==="
...
echo ""
echo "=== Rebuilding diff-gaussian-rasterization for sm_89 ==="
...
rm -rf "$BUILD_DIR"
echo ""
echo "=== Build complete for L40S (sm_89) ==="
